...
public class PostController {
    ...
    public ResponseEntity<PostDto> getSinglePostById(@PathVariable Integer postId){
        PostDto user_post = this.postService.getPostById(postId);
        return new ResponseEntity<PostDto>(user_post, HttpStatus.OK);
    }
    ...
    // image serving i.e to receive image from filename
