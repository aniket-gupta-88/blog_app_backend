...
import com.backendProject.blogger.payloads.PostDto;
import com.backendProject.blogger.payloads.PostResponse;
...
import com.backendProject.blogger.services.PostService;
...
public class PostServiceimpl implements PostService {
    ...
    public PostDto createPost(PostDto postDto,Integer userId, Integer categoryId ) {
        ...
        Category category = this.categoryRepo.findById(categoryId).orElseThrow(()-> new ResourceNotFoundException("Category", "Catergory id", categoryId));
    ...
    public PostResponse getAllPost(Integer pageNumber, Integer pageSize, String sortBy, String sortDir) {
        ...
        Sort sorted_data = null;
        if(sortDir.equalsIgnoreCase("asc")){
            sorted_data = Sort.by(sortBy).ascending();
        }
        else{
            sorted_data = Sort.by(sortBy).descending();
        }

        Pageable p = PageRequest.of(pageNumber, pageSize, sorted_data);
    ...
    public PostDto getPostById(Integer postId) {
        Post user_post = this.postRepo.findById(postId).orElseThrow(()-> new ResourceNotFoundException("Posts", "post id", postId));
        return this.modelMapper.map(user_post, PostDto.class);
    }
